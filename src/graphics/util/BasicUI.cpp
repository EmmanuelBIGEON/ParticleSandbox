...
void BasicUI::Init(GraphicContext* context)
{
    ...
    slider_repulsion = new Slider(context, 0.0f, 0.8f, &GraphicContext::repulsion_factor, m_startingX+ 75.0f, cursorY- 20.0f);
    cursorY -= 120.0f;
    ...
    slider_attraction = new Slider(context, 0.0f, 0.8f, &GraphicContext::attraction_factor, m_startingX+ 75.0f, cursorY -20.0f);
